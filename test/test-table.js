...
import Table from '../src/action/Table';
import robotFactory from '../src/action/Robot/factory';

describe('TableClass Test', function () {
  it('Able to place 1 robot at a specific location', function () {
  ...
  it('Able to place 2 robots at 2 specific locations', function () {
    const table = new Table({
      dimensions: { x: 5, y: 5 },
      isSafeMode: true
    });
  ...
  it('Able to place an existing robot at a new location', function () {
    const table = new Table({
      dimensions: { x: 5, y: 5 },
      isSafeMode: true
    });
