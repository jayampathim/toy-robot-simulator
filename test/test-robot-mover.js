...
import RobotMover from '../src/action/RobotMover';
...
describe('RobotMoverClass Test', function () {
  ...
  it('Able to move 1 step to the north direction', function () {
  ...
  it('Able to move 1 step to the south direction', function () {
  ...
  it('Able to move 1 step to the east direction', function () {
  ...
  it('Able to move 1 step to the west direction', function () {
  ...
  it('Able to throw an error when moving out of table facing NORTH', function () {
  ...
  it('Able to throw an error when moving out of table facing EAST', function () {
  ...
  it('Able to throw an error when moving out of table facing SOUTH', function () {
  ...
  it('Able to throw an error when moving out of table facing WEST', function () {
  ...
  it('Able to throw an error when giving an invalid direction', function () {
