...
describe('RobotHistoryClass Test', function () {
  ...
  it('Able to see isEmpty as true at the beginning', function () {
  ...
  it('Able to backup the current state', function () {
    history.backup();
  ...
  it('Able to undo and restore the current state', function () {
  ...
  it('Able to have the correct total number of backup states', function () {
    const histories = history.getAll();
    // in the above tests, we called "history.backup()" 3 times, and we undo 1 time
    // so there should be 2 states left in the history stack
